...
# First, implement simple multi-layer preceptron / neural network in Python and Numpy
...
from Ex1 import get_normalized_data, error_rate, cost, y2indicator
...
#end of multi-layer preceptron functions
